<?php if ($categories) : ?>
    ...
    <ul class="mt-5">
        ...
        <?php foreach ($categories as $category) : ?>
            <li class="sidebar-li mb-1 py-2" data-action=<?= $_overview ?? "filter-single-page"; ?> data-filter=<?= $_overview ? $category['id'] : $category['name']; ?> data-device=<?= $_sidebar; ?>><?= $category['title']; ?>
            </li>
        <?php endforeach; ?>
    </ul>
